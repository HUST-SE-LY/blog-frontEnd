<template>
  <div ref="container" class="container">
    ...
    <div class="box">
      ...
      <h1>引用</h1>
      <div class="link_box">
        <a href="https://github.com/imuncle/live2d" target="_blank">live2d看板</a>
        <a href="https://github.com/pbondoer/bubble-bg" target="_blank">背景动态气泡</a>
        <a href="https://neteasecloudmusicapi.vercel.app/#/">音乐接口提供</a>
      </div>
    </div>
  </div>
</template>
